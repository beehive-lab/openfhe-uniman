 ...
 * ring Dimension       = 32768     (is set internally by OpenFHE)
 * gpu blocks           = 32        (should be set manually at approx-switch-crt-basis.cu)
...
int main() {
    ...
    cudaUtils.initialize(64, 512, 25, 32768, 4, 13, 14);
    #endif
    ...
    // Output results
    std::cout << "\nResults of 12 homomorphic multiplications (1 * 1) : " << plaintextMultResult << std::endl;
